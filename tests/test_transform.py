...
@pytest.mark.dependency(
    depends=[
        ...
        "tests/test_contains.py::test_all",
    ],
    scope="session",
)
def test_begin():
...
class TestShift:
    ...
    def test_empty(self):
        ...
        assert move(empty, -1) == empty
        assert move(empty, 0) == empty
        assert move(empty, 1) == empty
    ...
    def test_whole(self):
        ...
        assert move(whole, -1) == whole
        assert move(whole, 0) == whole
        assert move(whole, 1) == whole
